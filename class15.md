Pathway Analysis from RNA-Seq Results (Class 15)
================
...
countData <- as.matrix(countData[,-1]) #the -1 removes the first column (you don't have to know how many more columns there are!)
```

Let’s remove the rows with zeroes in all experiments (aka columns)
...
Create a vector of ‘foldchanges’ values that has ENTREZ identifiers as
the names of the vector. This is the format that the **gage()** function
wants
...
```
    ...
    ## Info: Working in directory /Users/marinaiwama/Desktop/spring 19/bimm 143/bimm143_github/class15
